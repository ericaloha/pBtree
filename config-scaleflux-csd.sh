...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/scaleflux/csd3k/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/scaleflux/csd3k/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/scaleflux_csd3k.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    mkdir -p "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/scaleflux_csd3k-archive-keyring.gpg"
  gpg_key_path_old="/etc/apt/trusted.gpg.d/scaleflux_csd3k.gpg"
...
sudo apt-get install sfx-tools=1.0.0